    ...
    <section :style="[user ? {'justify-content': 'space-between'} : {'justify-content':'center'}]">
      <router-link to="/">
        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation"
          focusable="false"
          style="display: block; fill: none; height: 24px; width: 24px; stroke: #b0b0b0; stroke-width: 4px; overflow: visible;">
          <g fill="none">
            <path
      ...
      <router-link to="/wishlist">
        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation"
          focusable="false"
          style="display: block; fill: none !important; height: 24px; width: 24px; stroke: #b0b0b0; stroke-width: 2.66667; overflow: visible;">
          <path
...
export default {
  ...
  methods: {
    ...
    showFooter(){
      ...
      if(this.width<745 && !this.isScrollUp){
        this.isShowing=true
        return true
      }
