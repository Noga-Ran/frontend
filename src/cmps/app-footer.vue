<template>
  ...
  <footer class="mobile-footer-container" v-if="isScrollUp && width<745">
    <section>
      <router-link to="/">
        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: block; fill: none; height: 24px; width: 24px; stroke: #b0b0b0; stroke-width: 2,66667; overflow: visible;"><g fill="none"><path d="m13 24c6.0751322 0 11-4.9248678 11-11 0-6.07513225-4.9248678-11-11-11-6.07513225 0-11 4.92486775-11 11 0 6.0751322 4.92486775 11 11 11zm8-3 9 9"></path></g></svg>
        <p >Explore</p>
      </router-link>
...
export default {
  ...
  data() {
    return {
      ...
      pages: [{name:'Explore' ,icon:'https://res.cloudinary.com/nogacloud/image/upload/v1663567700/other/footer/glass.svg'},
      {name:'wishlist' ,icon:'https://res.cloudinary.com/nogacloud/image/upload/v1663567700/other/footer/heart.svg'},
      {name:'Trips' ,icon:'https://res.cloudinary.com/nogacloud/image/upload/v1663567700/other/footer/trips.svg'},
      {name:'Inbox' ,icon:'https://res.cloudinary.com/nogacloud/image/upload/v1663567700/other/footer/inbox.svg'},
      {name:'Profile' ,icon:'https://res.cloudinary.com/nogacloud/image/upload/v1663567700/other/footer/profile.svg'}]
    }
  },
  created() {
