      ...
      <section class="modal-container">
        ...
        <div class="modal-filter-container">
          <div class="filter-modal">
            ...
            <input type="checkbox" class="shared-room" name="sharedRoom" v-model="multyFilterBy.sharedRoom"
              @click="multyFilterBy.sharedRoom=!multyFilterBy.sharedRoom">
            <label for="sharedRoom"> Shared room <div class="grey">A sleeping space and common areas that may be shared
                with others</div></label><br>
